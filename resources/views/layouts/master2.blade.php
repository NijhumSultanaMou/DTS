...
<head>
  ...
  <link href="{{ asset('assets2/css/now-ui-dashboard.css?v=1.3.0')}}" rel="stylesheet" />
...
<body class="">
  <div class="wrapper ">
    ...
    <div class="sidebar" data-color="dark"> <!--data-color="blue | green | orange | red | yellow"-->
      <div class="logo">
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          <li class="{{ 'OwnerDashboard' == request()->path() ? 'active' : ''}}">
            <a href="/Owner/OwnerDashboard">
...
-->
  ...
  <script src="{{asset('assets2/js/now-ui-dashboard.min.js?v=1.3.0')}}" type="text/javascript"></script>
