...
<head>
  ...
  <link href="{{ asset('assets3/css/now-ui-dashboard.css?v=1.3.0')}}" rel="stylesheet" />
  ...
  <div class="wrapper ">
    ...
    <div class="sidebar" data-color="blue"> <!--data-color="blue | green | orange | red | yellow"-->
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          <li class="{{ 'TenantDashboard' == request()->path() ? 'active' : ''}}">
          ...
          <li>
            <a href="/Tenant/View">
              ...
              <p>View Necessity Post</p>
            </a>
          </li>

          <li>
            <a href="/Tenant/ViewProperty">
              <i class="now-ui-icons travel_info"></i>
              <p>View Property Post</p>
            </a>
          </li>
          <li>
            <a href="/Tenant/ViewArea">
              <i class="now-ui-icons files_paper"></i>
              <p>View Area Guide</p>
            </a>
          </li>
          <li>
            <a href="/Tenant/ViewPBlog">
              <i class="now-ui-icons files_paper"></i>
              <p>View Area Blogs</p>
            </a>
          </li>
...
-->
  ...
  <!-- Chart JS -->
  <script src="{{asset('assets3/js/plugins/chartjs.min.js')}}"></script>
  <!--  Notifications Plugin    -->
  <script src=".{{asset('assets3/js/plugins/bootstrap-notify.js')}}"></script>
  <!-- Control Center for Now Ui Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="{{asset('assets3/js/now-ui-dashboard.min.js?v=1.3.0')}}" type="text/javascript"></script>
