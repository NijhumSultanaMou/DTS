...
@endif  
<form action="{{route('Tenant.update',['id'=>$necessity->id])}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}        
      <div class="container">
                  ...
                  <div class="col-md-6">              
                     <div class="form-group">
                      <label>Mobile No:</label>
                          <input type="text" class="form-control" name="mobile" value="{{ $necessity->name}}" placeholder="Enter Mobile No">
                     </div>
                 </div>
               </div>
